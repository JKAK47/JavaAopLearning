 ...
 * InvocationHandler 接口中有一个invoke方法，当一个动态代理实例的方法被调用时，代理方法将被编码并分发到 InvocationHandler接口的invoke方法执行。
 */
public class PersonInvocationHandler<T> implements InvocationHandler {
    ...
    /**
     * 在该方法中实现对委托类的代理访问
     * @param proxy  代表JDK动态生成的 动态代理 对象实例
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
         ...
         */
        System.out.println("被动态代理类回调执行, 代理类 proxyClass ="+proxy.getClass()+" proxyClass.CanonicalName = "+proxy.getClass().getCanonicalName()+
